...
if __name__ == '__main__':
    ...
    # CUDA_VISIBLE_DEVICES=0 python eval_classification.py --model_ver vb --dataset_type m18  --checkpoint checkpoints/vb/m18_2/Best.pth.tar
    # CUDA_VISIBLE_DEVICES=0 python eval_classification.py --model_ver vbrm --dataset_type m18  --checkpoint checkpoints/vbrm/m18_2/Best.pth.tar
    ...
    # CUDA_VISIBLE_DEVICES=0 python eval_classification.py --model_ver vb --dataset_type c80  --checkpoint checkpoints/vb/c80/Best.pth.tar
    # CUDA_VISIBLE_DEVICES=0 python eval_classification.py --model_ver vbrm --dataset_type c80  --checkpoint checkpoints/vbrm/c80/Best.pth.tar
    ...
    # CUDA_VISIBLE_DEVICES=0 python eval_classification.py --model_ver vb --dataset_type psi  --checkpoint checkpoints/vb/psi/Best.pth.tar
    # CUDA_VISIBLE_DEVICES=0 python eval_classification.py --model_ver vbrm --dataset_type psi  --checkpoint checkpoints/vbrm/psi/Best.pth.tar
    ...
    parser.add_argument('--tokenizer_ver',  default= 'btv2',                                          help='btv2/btv3/gpt2v1')
    ...
    parser.add_argument('--save_output',    default= True,                                         help='True/False')
