...
" GPT2 + GC-ViT early fusion"
class EFGPT2GCVITClassification(nn.Module):
    def __init__(self, num_class = 12):
        super(EFGPT2GCVITClassification, self).__init__()

        ## image processing
        self.img_feature_extractor = model = create_model(
                                            'gc_vit_tiny',
                                            pretrained=False,
                                            num_classes=0,
                                            global_pool=None,
